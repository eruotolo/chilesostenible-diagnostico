            ...
            <div class="central-01">
                <div class="row ">
                    ...
                    <div class="col-6 preguntas">
                        <h6>¿Cuenta con un Presupuesto Anual para capacitaciones?</h6>
            ...
            <div class="barra-progress">
                <div class="row">
                    <div class="col-12 text-center barra">
                        <div class="progress">
                            <div class="progress-bar bg-primary" role="progressbar" style="width: 33.33%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <p>PAG 14/42</p>
                    </div>
                </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        ?>
            ...
            if ('<?php echo $preguntas["p11-1"] ?>' == 'Si') {
                $("#chechkbox-1").prop('checked', true);
                $('#otherFieldDiv').show();
            } else if ('<?php echo $preguntas["p11-1"] ?>' == 'No') {
