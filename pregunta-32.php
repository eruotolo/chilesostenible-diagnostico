            ...
            <div class="central-01">
                <div class="row">
                    ...
                    <div class="col-6 preguntas">
                        <h6>¿Su empresa considera criterios ambientales para el desarrollo de nuevos proyectos?</h6>
            ...
            <div class="barra-progress">
                <div class="row">
                    <div class="col-12 text-center barra">
                        <div class="progress">
                            <div class="progress-bar bg-primary" role="progressbar" style="width: 76.19%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <p>PAG 32/42</p>
                    </div>
                </div>
