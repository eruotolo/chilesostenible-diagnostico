            ...
            <div class="central-01">
                <div class="row">
                    ...
                    <div class="col-6 preguntas">
                        <h6>¿Su empresa ha creado planes de manejo de recursos naturales o se ha alineado con la Estrategia Nacional de Biodiversidad 2017-2030? <a class="btn_ayuda_01" href="#" data-placement="top" data-toggle="tooltip" title="Instrumento de política pública que establece los principales lineamientos estratégicos y metas nacionales en materia de conservación y uso sustentable de la biodiversidad al 2030. Pueden encontrarlo en la página web del Ministerio del Medio Ambiente."><img class="btn_ayuda" src="assets/image/btn_ayuda.svg" alt="ayuda"></a></h6>
            ...
            <div class="barra-progress">
                <div class="row">
                    <div class="col-12 text-center barra">
                        <div class="progress">
                            <div class="progress-bar bg-primary" role="progressbar" style="width: 61.90%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <p>PAG 26/42</p>
                    </div>
                </div>
