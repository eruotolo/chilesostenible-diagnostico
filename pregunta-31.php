            ...
            <div class="central-01">
                <div class="row">
                    ...
                    <div class="col-6 preguntas">
                        <h6>¿Su empresa tiene algún tipo de política o declaración de medioambiente? <a class="btn_ayuda_01" href="#" data-placement="top" data-toggle="tooltip" title="El objetivo de la declaración o política medioambiental, es facilitar al público y a otras partes interesadas, información medioambiental respecto del impacto y el comportamiento medioambiental de la organización y la mejora permanente del comportamiento en materia de medio ambiente en el marco de la organización."><img class="btn_ayuda" src="assets/image/btn_ayuda.svg" alt="ayuda"></a></h6>
            ...
            <div class="barra-progress">
                <div class="row">
                    <div class="col-12 text-center barra">
                        <div class="progress">
                            <div class="progress-bar bg-primary" role="progressbar" style="width: 73.81%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <p>PAG 31/42</p>
                    </div>
                </div>
