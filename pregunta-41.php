            ...
            <div class="central-01">
                <div class="row">
                    ...
                    <div class="col-6 preguntas">
                        <h6>¿Su empresa ha establecido metas de disminución de emisiones de gases de efecto invernadero, independientemente del crecimiento para las siguientes emisiones?</h6>
                        <div class="cont-checkbox">
                            <form action="" method="post" name="form1">
                                <div class="check-box">
                                    <input name="" class="" type="checkbox" value="1" id="chechkbox-1" onclick='chkcontrol(0)'>
                                    <label class="" for="chechkbox-1">Estableció metas para el alcance 1 <a class="btn_ayuda_01" href="#" data-placement="top" data-toggle="tooltip" title="Son aquellas emisiones de gases de efecto invernadero que provienen de fuentes que son propiedad o son controladas por la empresa, como por ejemplo, consumo de combustibles fósiles en fuentes fijas y/o móviles, fugas no intencionadas de los equipos de climatización, entre otras."><img class="btn_ayuda" src="assets/image/btn_ayuda.svg" alt="ayuda"></a></label>
                                </div>
                                <div class="check-box">
                                    <input name="" class="" type="checkbox" value="2" id="chechkbox-2" onclick='chkcontrol(0)'>
                                    <label class="" for="chechkbox-2">Estableció metas para el alcance 2 <a class="btn_ayuda_01" href="#" data-placement="top" data-toggle="tooltip" title="Corresponden a las emisiones de gases de efecto invernadero asociadas al consumo de electricidad y/o vapor generados por terceros."><img class="btn_ayuda" src="assets/image/btn_ayuda.svg" alt="ayuda"></a></label>
                                </div>
                                <div class="check-box">
                                    <input name="" class="" type="checkbox" value="3" id="chechkbox-3" onclick='chkcontrol(0)'>
                                    <label class="" for="chechkbox-3">Estableció metas para el alcance 3 <a class="btn_ayuda_01" href="#" data-placement="top" data-toggle="tooltip" title="Son aquellas emisiones de gases de efecto invernadero que no son de propiedad ni están controladas por la empresa, como por ejemplo, transporte de los funcionarios, viajes aéreos o terrestres por motivos de trabajo, transporte de insumos, generación y transporte de residuos, entre otros."><img class="btn_ayuda" src="assets/image/btn_ayuda.svg" alt="ayuda"></a></label>
                                </div>
                                <div class="check-box">
            ...
            <div class="barra-progress">
                <div class="row">
                    <div class="col-12 text-center barra">
                        <div class="progress">
                            <div class="progress-bar bg-primary" role="progressbar" style="width: 97.62%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <p>PAG 41/42</p>
                    </div>
                </div>
