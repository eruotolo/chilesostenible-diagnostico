            ...
            <div class="central-01">
                <div class="row">
                    ...
                    <div class="col-6 preguntas">
                        <h6>¿Cuáles de los siguientes programas o políticas son implementados por la empresa para promover la diversidad en la cadena de suministro?</h6>
                        <div class="cont-checkbox scroll-09">
            ...
            <div class="barra-progress">
                <div class="row">
                    <div class="col-12 text-center barra">
                        <div class="progress">
                            <div class="progress-bar bg-primary" role="progressbar" style="width: 47.62%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <p>PAG 20/42</p>
                    </div>
                </div>
