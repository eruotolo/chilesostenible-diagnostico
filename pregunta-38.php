            ...
            <div class="central-01">
                <div class="row">
                    ...
                    <div class="col-6 preguntas">
                        <h6>¿Su empresa ha tomado en consideración generar planes de diversificación de su matriz energética?</h6>
            ...
            <div class="barra-progress">
                <div class="row">
                    <div class="col-12 text-center barra">
                        <div class="progress">
                            <div class="progress-bar bg-primary" role="progressbar" style="width: 90.48%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <p>PAG 38/42</p>
                    </div>
                </div>
